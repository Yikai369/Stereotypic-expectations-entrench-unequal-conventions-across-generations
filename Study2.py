...
def study2(
    ...
    study_number = study2_config.study_number 
    num_epoch = study2_config.num_epoch
    num_run = study2_config.num_run
    max_turns = study2_config.max_turns
    population_sizes = study2_config.population_sizes
    prop = study2_config.prop
    ...
    strong_skill = study2_config.strong_skill
    weak_skill = study2_config.weak_skill
            ...
            for epoch in range(num_epoch):
                ...
                while done != 1:
                    ...
                    for agent in action_order:
                        ...
                        state, _ = generate_input(agent_list, agent, agent_list[agent].state)
